...
- **Lore:** The Thought-Sync's promise of true machine sentience
- Progress counters build up, providing scry value (useful predictions)
- But when it "completes," you draw a lot then discard everything—the promise delivers, but not what you expected
- The 5-counter threshold represents the perpetually moving goalpost
