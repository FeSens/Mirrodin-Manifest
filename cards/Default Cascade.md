...
## Image Prompt
> Default Cascade — Enchantment. Visual focus: A cascade of falling debt contracts, each one spawning two more as it's destroyed — an endless waterfall of obligation. Setting: Vault of Whispers/Dross Dominion — financial abyss chamber. Mood: Corrupted triumph. Style reference: Seb McKinnon meets Nils Hamm. Color palette: Near-black, dark red contracts, olive shadows.

## Design Notes
- Rakdos uncommon enchantment
- Prevents easy debt escape
- Creates cascading debt (pay one, get another)
- Financial doom trap
- Works against [[Bankruptcy Filing]], [[Jubilee Declaration]]
- Pairs with: [[Interest Rate Hike]], [[Vulture Capitalist]]
- **Restriction added:** "Once each turn" clause prevents infinite debt loops with Debt Ceiling and similar effects that would create inescapable lock states
