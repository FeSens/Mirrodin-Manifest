...
## Rules Text
> As Control The Narrative enters, choose two creature types.
>
> Creatures of the first chosen type have protection from creatures of the second chosen type.

## Flavor Text
> *"The Glimmer-Barge logs told stories the Synod refused to read. When the Unforged finally spoke, the chamber had already adjourned—permanently."*
...
- Choose two creature types: the first is protected FROM the second (e.g., "Vedalken have protection from Unforged")
- **Lore connection:** [[Lore#The Great Ep-Styn Mystery]] - Directly references the Redacted Archives and the Synod's complicity
- White/Black represents the corruption of Synod institutions (white order) by Vault self-interest (black secrecy)
- References the Glimmer-Barges that transported the Unforged to Ep-Styn's Private Isle
- The Redaction-Myr in the art are the literal censors who scrubbed the Black Ledger
- Gameplay: Name "Vedalken" and "Unforged" to protect corrupt Synod officials from victim testimony
